...
CREATE NONCLUSTERED INDEX [IFACTURA1] ON [Factura] ( 
      [cliId])
CREATE NONCLUSTERED INDEX [IFACTURA2] ON [Factura] ( 
      [usuId])
ALTER TABLE [Factura] 
...
CREATE TABLE [FacturaDetalle] ( 
  [facId]          INT    NOT NULL, 
  [detFacId]       INT    NOT NULL Identity(1,1), 
  [proId]          INT    NOT NULL, 
