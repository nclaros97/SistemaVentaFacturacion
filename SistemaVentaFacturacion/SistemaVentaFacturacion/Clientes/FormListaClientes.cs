...
namespace SistemaVentaFacturacion.Clientes
{
    public partial class FormListaClientes : Form
    {
        ...
        private void FormListaClientes_Load(object sender, EventArgs e)
        {
            ...
            GridClientes.DataSource = scriptFacturacion.getDataCliente();
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            if (GridClientes.SelectedRows.Count == 1)
            {
                ...
                {
                    scriptFacturacion.deleteCliente(Convert.ToInt32(GridClientes.CurrentRow.Cells[0].Value.ToString()));
                    GridClientes.DataSource = scriptFacturacion.getDataCliente();
                }
                else
                {
